...
> **总体输出文件**为.txt形式，每一行(14个值,以空格间隔)记录某一帧某一物体信息，具体字段如下：

> 第1个值：代表帧数；   
> 第2个值：代表时间戳；    
> 第3个值：代表物体uid；   
> 第4个值：代表类别，可以为['Car', 'Van', 'Truck','Pedestrian', 'Person_sitting', 'Cyclist','Tram', 'Misc' , 'DontCare']；     
...
<img src="https://github.com/user-attachments/assets/c3cae551-57b6-49a8-988a-b4dcd4131ef0" width="750px">
